...
typedef enum
{
        ...
        XTP_MENU_ITEM_ALLOW_WINDOW_OPS,
        XTP_MENU_ITEM_ALLOW_TITLE_OPS,
        XTP_MENU_ITEM_UTF8_TITLE,
        XTP_MENU_ITEM_ALLOW_COLOR_OPS,
        XTP_MENU_ITEM_ALLOW_FONT_OPS,
        XTP_MENU_ITEM_ALLOW_TCAP_OPS,
        XTP_MENU_ITEM_ALLOW_MOUSE_OPS,
