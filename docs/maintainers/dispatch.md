...
The T1a/C1/T1c/W1/P2a batch is complete. Its behavior and evidence are recorded
in the compatibility ledger and probe reference. Dispatch only remaining items
from `todo.md`; do not reopen completed policy or hold work as a prerequisite
for T1b or the other P2 options.
...
| --- | --- | --- |
| T1b | UTF-8 title surface | [resource-utf8-title](https://toppk.github.io/revenant/tdn/features/resource-utf8-title/), [x11-utf8-title-properties](https://toppk.github.io/revenant/tdn/features/x11-utf8-title-properties/) |
