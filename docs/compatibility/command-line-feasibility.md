...
| `-/+fbx` | `forceBoxChars`: internal line-drawing glyphs | Renderer | Cell-geometry rasterizer for all supported procedural ranges, shared with the `font-linedrawing` menu entry | DONE |
