...
| XTP Styled Emoji Regular/Bold/Italic | Generated by `make-styled-emoji.py` | Project MIT license | Generated bars with no third-party artwork. Real styles with deliberate metrics: two-em regular and bold glyphs, and a half-em italic glyph that a GSUB multiple substitution decomposes into two. |
